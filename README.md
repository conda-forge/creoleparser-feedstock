...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/creoleparser-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/creoleparser-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add creoleparser
# for installing globally
pixi global install creoleparser
```
...
It is possible to list all of the versions of `creoleparser` available on your platform:
...
```
pixi search creoleparser --channel conda-forge
```
